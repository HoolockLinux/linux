...
static const struct midr_range apple_erratum_wfi_state_cpus[] = {
	MIDR_ALL_VERSIONS(MIDR_APPLE_A7_CYCLONE),
	MIDR_ALL_VERSIONS(MIDR_APPLE_A8_TYPHOON),
	MIDR_ALL_VERSIONS(MIDR_APPLE_A8X_TYPHOON),
	MIDR_ALL_VERSIONS(MIDR_APPLE_SAMSUNG_TWISTER),
	MIDR_ALL_VERSIONS(MIDR_APPLE_TSMC_TWISTER),
	MIDR_ALL_VERSIONS(MIDR_APPLE_A10_T2_HURRICANE_ZEPHYR),
	MIDR_ALL_VERSIONS(MIDR_APPLE_A10X_HURRICANE_ZEPHYR),
	MIDR_ALL_VERSIONS(MIDR_APPLE_A11_MONSOON),
	MIDR_ALL_VERSIONS(MIDR_APPLE_A11_MISTRAL),
	MIDR_ALL_VERSIONS(MIDR_APPLE_M1_ICESTORM),
	MIDR_ALL_VERSIONS(MIDR_APPLE_M1_FIRESTORM),
	MIDR_ALL_VERSIONS(MIDR_APPLE_M1_ICESTORM_PRO),
	MIDR_ALL_VERSIONS(MIDR_APPLE_M1_FIRESTORM_PRO),
	...
	MIDR_ALL_VERSIONS(MIDR_APPLE_M2_BLIZZARD_MAX),
	MIDR_ALL_VERSIONS(MIDR_APPLE_M2_AVALANCHE_MAX),
	MIDR_ALL_VERSIONS(MIDR_APPLE_M3_SAWTOOTH),
	MIDR_ALL_VERSIONS(MIDR_APPLE_M3_EVEREST),
	MIDR_ALL_VERSIONS(MIDR_APPLE_M3_SAWTOOTH_PRO),
	MIDR_ALL_VERSIONS(MIDR_APPLE_M3_EVEREST_PRO),
	MIDR_ALL_VERSIONS(MIDR_APPLE_M3_SAWTOOTH_MAX),
	MIDR_ALL_VERSIONS(MIDR_APPLE_M3_EVEREST_MAX),
	MIDR_ALL_VERSIONS(MIDR_APPLE_M4_ECORE),
	MIDR_ALL_VERSIONS(MIDR_APPLE_M4_PCORE),
	MIDR_ALL_VERSIONS(MIDR_APPLE_M4_PRO_ECORE),
	MIDR_ALL_VERSIONS(MIDR_APPLE_M4_PRO_PCORE),
	MIDR_ALL_VERSIONS(MIDR_APPLE_M4_MAX_ECORE),
	MIDR_ALL_VERSIONS(MIDR_APPLE_M4_MAX_PCORE),
	MIDR_ALL_VERSIONS(MIDR_APPLE_A18_PRO_ECORE),
	MIDR_ALL_VERSIONS(MIDR_APPLE_A18_PRO_PCORE),
	MIDR_ALL_VERSIONS(MIDR_APPLE_M5_ECORE),
	MIDR_ALL_VERSIONS(MIDR_APPLE_M5_PCORE),
	MIDR_ALL_VERSIONS(MIDR_APPLE_M5_PRO_ECORE),
	MIDR_ALL_VERSIONS(MIDR_APPLE_M5_PRO_PCORE),
	MIDR_ALL_VERSIONS(MIDR_APPLE_M5_MAX_ECORE),
	MIDR_ALL_VERSIONS(MIDR_APPLE_M5_MAX_PCORE),
	{},
};
...
#define CYC_OVRD_WFI_MODE(x)   (x << 24)
#define CYC_OVRD_WFI_MODE_MASK (3UL << 24)
	if (!is_midr_in_range_list(apple_erratum_wfi_state_cpus))
		return false;
	return (read_sysreg_s(SYS_IMP_APL_CYC_OVRD) & CYC_OVRD_WFI_MODE_MASK)
		!= CYC_OVRD_WFI_MODE(2);
}
